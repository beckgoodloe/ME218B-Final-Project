...
#define SERV_0_HEADER "RobotFSM.h"
// the name of the Init function
#define SERV_0_INIT InitRobotFSM
// the name of the run function
#define SERV_0_RUN RunRobotFSM
...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "spudFSM.h"
// the name of the Init function
#define SERV_1_INIT InitSPUDFSM
// the name of the run function
#define SERV_1_RUN RunSPUDFSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 2
// the header file with the public function prototypes
#define SERV_2_HEADER "BeaconDetect.h"
// the name of the Init function
#define SERV_2_INIT InitBeaconDetect
// the name of the run function
#define SERV_2_RUN RunBeaconDetect
// How big should this services Queue be?
// For I2C Service, Queue should be at least 5
...
#if NUM_SERVICES > 3
// the header file with the public function prototypes
#define SERV_3_HEADER "DriveSM.h"
// the name of the Init function
#define SERV_3_INIT InitDriveSM
// the name of the run function
#define SERV_3_RUN RunDriveSM
// How big should this services Queue be?
...
#if NUM_SERVICES > 4
// the header file with the public function prototypes
#define SERV_4_HEADER  "CorporateManagement.h"
// the name of the Init function
#define SERV_4_INIT InitCorporateManagement
// the name of the run function
#define SERV_4_RUN RunCorporateManagement
// How big should this services Queue be?
...
#if NUM_SERVICES > 5
// the header file with the public function prototypes
#define SERV_5_HEADER "AccelService.h"
// the name of the Init function
#define SERV_5_INIT InitAccelService
// the name of the run function
#define SERV_5_RUN RunAccelService
// How big should this services Queue be?
...
#if NUM_SERVICES > 6
// the header file with the public function prototypes
#define SERV_6_HEADER "Planner.h"
// the name of the Init function
#define SERV_6_INIT InitPlanner
// the name of the run function
#define SERV_6_RUN RunPlanner
// How big should this services Queue be?
...
#if NUM_SERVICES > 7
// the header file with the public function prototypes
#define SERV_7_HEADER "StallService.h"
// the name of the Init function
#define SERV_7_INIT InitStallService
// the name of the run function
#define SERV_7_RUN RunStallService
// How big should this services Queue be?
...
typedef enum
{
  ...
  EV_STALL,
  EV_POSITION_REACHED,
  EV_ROTATION_COMPLETED,
  EV_STRAIGHT_COMPLETED,
  Stop,
  MoveFwd,
  MoveFwdDist,
  MoveRev,
...
#if NUM_DIST_LISTS > 0
#define DIST_LIST0 PostBeaconDetect
#endif
#if NUM_DIST_LISTS > 1
...
#define EVENT_CHECK_LIST Check4Keystroke, Check4Miner
...
#define TIMER1_RESP_FUNC PostSPUDFSM
#define TIMER2_RESP_FUNC PostBeaconDetect
#define TIMER3_RESP_FUNC PostAccelService
#define TIMER4_RESP_FUNC PostPlanner
#define TIMER5_RESP_FUNC PostDriveSM
#define TIMER6_RESP_FUNC PostRobotFSM
#define TIMER7_RESP_FUNC PostCorporateManagement
#define TIMER8_RESP_FUNC TIMER_UNUSED
#define TIMER9_RESP_FUNC TIMER_UNUSED
#define TIMER10_RESP_FUNC TIMER_UNUSED
#define TIMER11_RESP_FUNC TIMER_UNUSED
#define TIMER12_RESP_FUNC PostBeaconDetect
#define TIMER13_RESP_FUNC PostDriveSM
#define TIMER14_RESP_FUNC TIMER_UNUSED
#define TIMER15_RESP_FUNC PostDriveSM
...
#define ACCEL_TIMER 3
#define MEASURE_TIMER 4
#define ACCEL_FLAG 5
#define SNUGGLE_TIMER 6
#define BLINK_TIMER 7
#define BEACON_NOT_FOUND_TIMER 12
#define COLLISION_TIMER 13
#define BUMP_MONITOR 15
#define STALL_TIMER 11
// TODO: If you add another timer, add it to StopAllTimers in RobotFSM
